...
class TestKauppa(unittest.TestCase):
    ...
    def test_kahden_eri_tuotteen_joista_toista_ei_ole_varastossa_ostoksen_paaytyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_argumenteilla(self):
        # tehdään toteutus saldo-metodille
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
    ...
    def test_varmistetaan_etta_aloita_asiointi_nollaa_edellisen_ostoksen_tiedot(self):
        # tehdään toteutus saldo-metodille
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
    ...
    def test_poista_korista_metodi_palauttaa_tuotteen_varastoon(self):
        ...
        self.varasto_mock.hae_tuote.return_value = tuote_mock

        kauppa.poista_korista(1)

        self.varasto_mock.hae_tuote.assert_called_once_with(1)
        ostoskori_mock.poista.assert_called_once_with(tuote_mock)
        self.varasto_mock.palauta_varastoon.assert_called_once_with(tuote_mock)